...
END $$;--> statement-breakpoint
DO $$ BEGIN
  CREATE TYPE "public"."weekly_goal_target_type" AS ENUM('open_pr', 'merge_pr', 'complete_lesson', 'custom');
EXCEPTION
  WHEN duplicate_object THEN NULL;
END $$;--> statement-breakpoint
DO $$ BEGIN
  CREATE TYPE "public"."xp_source_type" AS ENUM('lesson_complete', 'chapter_quiz_passed', 'project_submitted', 'project_approved', 'merged_pr', 'roadmap_complete', 'achievement');
EXCEPTION
  WHEN duplicate_object THEN NULL;
END $$;--> statement-breakpoint
ALTER TYPE "public"."submission_status" ADD VALUE IF NOT EXISTS 'needs_changes' BEFORE 'approved';--> statement-breakpoint
...
ALTER TABLE "project_submissions" ADD COLUMN IF NOT EXISTS "screenshot_urls" jsonb DEFAULT '[]'::jsonb NOT NULL;--> statement-breakpoint
...
ALTER TABLE "users" ADD COLUMN IF NOT EXISTS "linkedin_url" text;--> statement-breakpoint
ALTER TABLE "users" ADD COLUMN IF NOT EXISTS "skills" jsonb DEFAULT '[]'::jsonb NOT NULL;--> statement-breakpoint
ALTER TABLE "users" ADD COLUMN IF NOT EXISTS "email_notifications" jsonb DEFAULT '{"reviewOutcomes":true,"reviewQueue":true,"achievements":true,"product":true}'::jsonb NOT NULL;--> statement-breakpoint
...
DO $$ BEGIN
  ALTER TABLE "github_commits" ADD CONSTRAINT "github_commits_user_id_users_id_fk" FOREIGN KEY ("user_id") REFERENCES "public"."users"("id") ON DELETE cascade ON UPDATE no action;
EXCEPTION
  WHEN duplicate_object THEN NULL;
END $$;--> statement-breakpoint
DO $$ BEGIN
...
END $$;--> statement-breakpoint
DO $$ BEGIN
  ALTER TABLE "github_contribution_days" ADD CONSTRAINT "github_contribution_days_user_id_users_id_fk" FOREIGN KEY ("user_id") REFERENCES "public"."users"("id") ON DELETE cascade ON UPDATE no action;
EXCEPTION
  WHEN duplicate_object THEN NULL;
END $$;--> statement-breakpoint
DO $$ BEGIN
...
END $$;--> statement-breakpoint
DO $$ BEGIN
  ALTER TABLE "github_repositories" ADD CONSTRAINT "github_repositories_user_id_users_id_fk" FOREIGN KEY ("user_id") REFERENCES "public"."users"("id") ON DELETE cascade ON UPDATE no action;
EXCEPTION
  WHEN duplicate_object THEN NULL;
END $$;--> statement-breakpoint
DO $$ BEGIN
...
END $$;--> statement-breakpoint
DO $$ BEGIN
  ALTER TABLE "user_chapter_quizzes" ADD CONSTRAINT "user_chapter_quizzes_user_id_users_id_fk" FOREIGN KEY ("user_id") REFERENCES "public"."users"("id") ON DELETE cascade ON UPDATE no action;
EXCEPTION
  WHEN duplicate_object THEN NULL;
END $$;--> statement-breakpoint
DO $$ BEGIN
...
CREATE INDEX IF NOT EXISTS "github_contribution_days_user_id_idx" ON "github_contribution_days" USING btree ("user_id");--> statement-breakpoint
...
CREATE INDEX IF NOT EXISTS "github_issues_relation_idx" ON "github_issues" USING btree ("relation");--> statement-breakpoint
...
CREATE INDEX IF NOT EXISTS "github_pull_requests_contribution_type_idx" ON "github_pull_requests" USING btree ("contribution_type");--> statement-breakpoint
...
CREATE UNIQUE INDEX IF NOT EXISTS "user_weekly_goals_user_week_title_idx" ON "user_weekly_goals" USING btree ("user_id","week_start","title");--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "user_weekly_goals_user_id_idx" ON "user_weekly_goals" USING btree ("user_id");--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "user_weekly_goals_week_start_idx" ON "user_weekly_goals" USING btree ("week_start");--> statement-breakpoint
...
CREATE INDEX IF NOT EXISTS "submission_review_events_created_at_idx" ON "submission_review_events" USING btree ("created_at");--> statement-breakpoint
...
CREATE INDEX IF NOT EXISTS "submission_reviews_reviewer_id_idx" ON "submission_reviews" USING btree ("reviewer_id");--> statement-breakpoint
CREATE UNIQUE INDEX IF NOT EXISTS "user_chapter_quizzes_user_roadmap_quiz_idx" ON "user_chapter_quizzes" USING btree ("user_id","roadmap_slug","quiz_id");--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "user_chapter_quizzes_user_id_idx" ON "user_chapter_quizzes" USING btree ("user_id");--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "user_chapter_quizzes_roadmap_slug_idx" ON "user_chapter_quizzes" USING btree ("roadmap_slug");--> statement-breakpoint
...
CREATE INDEX IF NOT EXISTS "xp_events_source_type_idx" ON "xp_events" USING btree ("source_type");--> statement-breakpoint
DO $$ BEGIN
