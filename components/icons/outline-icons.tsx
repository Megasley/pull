...
export function SparklesIcon({ className }: IconProps) {
  return (
    <svg
      ...
      aria-hidden
    >
      <path d="M9.94 9.94 12 2l2.06 7.94L22 12l-7.94 2.06L12 22l-2.06-7.94L2 12l7.94-2.06Z" />
      <path d="M18 2v4" />
      <path d="M20 4h-4" />
    </svg>
  );
...
export function StarIcon({ className }: IconProps) {
  return (
    <svg
      ...
      aria-hidden
    >
      <path d="M12 3 14.5 8.5 20.5 9.3 16 13.4 17.2 19.4 12 16.5 6.8 19.4 8 13.4 3.5 9.3 9.5 8.5 12 3z" />
    </svg>
  );
}
...
export function MapIcon({ className }: IconProps) {
  return (
    <svg
      ...
      aria-hidden
    >
      <path d="M3 6 9 3 15 6 21 3v15l-6 3-6-3-6 3z" />
      <path d="M9 3v18" />
      <path d="M15 6v18" />
    </svg>
  );
