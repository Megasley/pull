      ...
      {open ? (
        ...
        >
          ...
          >
            ...
            <h2 id={titleId} className="mt-2 text-xl font-bold tracking-[-0.03em]">
            ...
            >
              Claim flow coming soon. When ready, maintainers will verify ownership and
              unlock content management and contributor resources on Pull.
            </p>
