...
<Mermaid
  caption="Offers bootstrap fresh invoices without out-of-band QR churn."
...
<Callout type="info" title="Check feature support">
  Before betting a product on offers, verify your target wallets and node
  implementations support the flows you need.
</Callout>
