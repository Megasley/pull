...
<Mermaid
  caption="LNURL-pay mints a fresh BOLT11 through an HTTPS handshake."
...
<Callout type="warning" title="You inherit web risks">
  Phishing, TLS failures, and malicious metadata become Lightning UX risks. Validate
  domains and amounts carefully.
</Callout>
