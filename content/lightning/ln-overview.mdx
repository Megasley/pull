...
<Mermaid
  caption="Total capacity is fixed until you splice or close; payments slide the balance boundary."
  chart="flowchart LR
...
<Mermaid
  caption="Lightning hops across channels; Bitcoin settles channel open/close."
  chart="flowchart LR
...
<Callout type="info" title="Channels are bilateral">
  A channel exists between two nodes. Routing stitches channels into a network so
  payments can cross multiple peers.
</Callout>
