...
<Mermaid
  caption="A route fails when any hop lacks outbound on the forward edge."
  chart="flowchart LR
...
<Callout type="warning" title="Funded does not mean receive-ready">
  A merchant with 10 BTC locked across channels but zero inbound on the invoice route
  still cannot get paid.
</Callout>
