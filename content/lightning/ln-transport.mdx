...
<Mermaid
  caption="Noise handshake authenticates node identity and encrypts BOLT messages."
  chart="flowchart LR
...
<Callout type="warning" title="Encryption ≠ economic security">
  Transport secrecy does not stop channel probing, fee griefing, or offline breach risk.
  It is one layer in LN security.
</Callout>
