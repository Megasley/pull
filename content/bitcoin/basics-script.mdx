...
lab:
  ...
  description: >-
    Complete the Decoding Bitcoin output-type ladder through P2PKH (required),
    then either finish one P2SH/P2MS exercise or the stack project. Optionally
    verify a matching template on regtest with `decodescript` / descriptors.
  evidence:
...
5. **SegWit / Taproot** - witness programs (`P2WPKH`, `P2WSH`, `P2TR`) - covered in later lessons
