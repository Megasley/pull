...
<Mermaid caption="Derivation is one-way: addresses do not reveal private keys." chart="flowchart LR
...
<Callout type="warning" title="Checksums are not enough">
  Address checksums catch typos, but they do not stop you from sending to the wrong person or the wrong network.
</Callout>
