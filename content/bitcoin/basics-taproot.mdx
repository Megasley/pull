...
<Mermaid
  caption="The output key commits to an optional script tree without revealing it upfront."
  chart="flowchart TD
...
<Callout type="info" title="Privacy wins when you cooperate">
  If parties always cooperate, they can prefer key-path spends so onlookers cannot tell
  a complex policy was involved.
</Callout>
