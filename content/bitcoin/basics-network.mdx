...
<Mermaid
  caption="Peers validate then gossip; compact blocks reduce bandwidth."
...
<Callout type="warning" title="Light client privacy">
  Querying a random server for “txs to my address” leaks ownership. Prefer filters,
  client-side scanning, or your own node.
</Callout>
