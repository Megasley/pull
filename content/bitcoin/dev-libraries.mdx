...
<Mermaid
  caption="Apps compose libraries for keys, tx building, and signing workflows."
  chart="flowchart TD
...
<Callout type="warning" title="Pin and audit upgrades">
  Consensus-adjacent upgrades can change defaults. Pin versions, read release notes, and
  run vectors/tests before production deploys.
</Callout>
