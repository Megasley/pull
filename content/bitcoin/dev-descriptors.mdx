...
<Mermaid
  caption="Policies compile to scripts wrapped by portable descriptors."
  chart="flowchart LR
...
<Callout type="tip" title="Backup descriptors with seeds">
  For Taproot script trees and multisig, seed words alone may be insufficient. Store
  descriptors (and multisig key records) with the same care as seeds.
</Callout>
