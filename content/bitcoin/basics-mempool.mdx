...
<Callout type="info" title="Policy ≠ consensus">
  A transaction can be consensus-valid yet non-standard under default mempool policy. Test relay behavior, not only block validity on regtest miner shortcuts.
</Callout>
