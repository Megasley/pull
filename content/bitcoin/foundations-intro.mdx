...
objectives:
  ...
  - Understand the recommended BuilderOS project layout
...
Most BuilderOS lessons assume you can run a modern **JavaScript** or **Rust** toolchain. Pick one primary language for app code, but keep both runtimes available for ecosystem tooling.
