...
<Mermaid
  caption="Stronger local verification costs more; lighter clients assume more about peers and servers."
  chart="flowchart TD
...
<Callout type="info" title="Label the model in your README">
  Users deserve to know whether your app verifies scripts, trusts an indexer, or uses
  filters. Silence is a product bug.
</Callout>
...
- Ignoring that light clients can be lied to about _absence_ of transactions
